...
(function () {
  ...
  $(document).ready(function () {
    $("#side-1").on('click', function () {
        $("#sub-1").addClass("razer-sidenav-submenu-active");
    });
    $("#side-2").on('click', function () {
      $("#sub-2").addClass("razer-sidenav-submenu-active");
    });
    $("#side-1").hover(function(){
      if ($("#sub-2")){
        $("#sub-2").removeClass("razer-sidenav-submenu-active");
      }
    })
    $("#side-2").hover(function(){
      if ($("#sub-1")){
